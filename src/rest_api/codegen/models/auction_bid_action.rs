...
pub struct AuctionBidAction {
    ...
    pub nft: Option<Box<crate::rest_api::codegen::models::NftItem>>,
    #[serde(rename = "bidder")]
    pub bidder: Box<crate::rest_api::codegen::models::AccountAddress>,
    #[serde(rename = "auction")]
    pub auction: Box<crate::rest_api::codegen::models::AccountAddress>,
}
...
impl AuctionBidAction {
    pub fn new(
        ...
        bidder: crate::rest_api::codegen::models::AccountAddress,
        auction: crate::rest_api::codegen::models::AccountAddress,
    ) -> AuctionBidAction {
        AuctionBidAction {
            auction_type,
