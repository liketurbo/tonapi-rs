...
pub struct Transaction {
    ...
    pub orig_status: crate::rest_api::codegen::models::AccountStatus,
    #[serde(rename = "end_status")]
    pub end_status: crate::rest_api::codegen::models::AccountStatus,
    #[serde(rename = "total_fees")]
    pub total_fees: i64,
    #[serde(rename = "transaction_type")]
    pub transaction_type: crate::rest_api::codegen::models::TransactionType,
    ...
    pub in_msg: Option<Box<crate::rest_api::codegen::models::Message>>,
    #[serde(rename = "out_msgs")]
    pub out_msgs: Vec<crate::rest_api::codegen::models::Message>,
    #[serde(rename = "block")]
    pub block: String,
    ...
    pub compute_phase: Option<Box<crate::rest_api::codegen::models::ComputePhase>>,
    #[serde(rename = "storage_phase", skip_serializing_if = "Option::is_none")]
    pub storage_phase: Option<Box<crate::rest_api::codegen::models::StoragePhase>>,
    #[serde(rename = "credit_phase", skip_serializing_if = "Option::is_none")]
    pub credit_phase: Option<Box<crate::rest_api::codegen::models::CreditPhase>>,
    #[serde(rename = "action_phase", skip_serializing_if = "Option::is_none")]
    pub action_phase: Option<Box<crate::rest_api::codegen::models::ActionPhase>>,
    #[serde(rename = "bounce_phase", skip_serializing_if = "Option::is_none")]
    pub bounce_phase: Option<crate::rest_api::codegen::models::BouncePhaseType>,
...
impl Transaction {
    pub fn new(
        ...
        success: bool,
        utime: i64,
        orig_status: crate::rest_api::codegen::models::AccountStatus,
        end_status: crate::rest_api::codegen::models::AccountStatus,
        total_fees: i64,
        transaction_type: crate::rest_api::codegen::models::TransactionType,
        state_update_old: String,
        state_update_new: String,
        out_msgs: Vec<crate::rest_api::codegen::models::Message>,
        block: String,
        aborted: bool,
        destroyed: bool,
    ) -> Transaction {
