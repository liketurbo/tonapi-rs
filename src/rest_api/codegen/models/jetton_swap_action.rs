...
pub struct JettonSwapAction {
    ...
    pub user_wallet: Box<crate::rest_api::codegen::models::AccountAddress>,
    #[serde(rename = "router")]
    pub router: Box<crate::rest_api::codegen::models::AccountAddress>,
    #[serde(rename = "jetton_master_in", skip_serializing_if = "Option::is_none")]
    pub jetton_master_in: Option<Box<crate::rest_api::codegen::models::JettonPreview>>,
    #[serde(rename = "jetton_master_out", skip_serializing_if = "Option::is_none")]
    pub jetton_master_out: Option<Box<crate::rest_api::codegen::models::JettonPreview>>,
}
...
impl JettonSwapAction {
    pub fn new(
        ...
        amount_in: String,
        amount_out: String,
        user_wallet: crate::rest_api::codegen::models::AccountAddress,
        router: crate::rest_api::codegen::models::AccountAddress,
    ) -> JettonSwapAction {
        JettonSwapAction {
            dex,
            amount_in,
