...
pub async fn dns_resolve(
...
) -> Result<crate::rest_api::codegen::models::DnsRecord, Error<DnsResolveError>> {
    ...
    let local_var_uri_str = format!(
        ...
        domain_name = crate::rest_api::codegen::apis::urlencode(domain_name)
    );
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<DnsResolveError> =
...
pub async fn get_all_auctions(
...
) -> Result<crate::rest_api::codegen::models::Auctions, Error<GetAllAuctionsError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetAllAuctionsError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_dns_info(
...
) -> Result<crate::rest_api::codegen::models::DomainInfo, Error<GetDnsInfoError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetDnsInfoError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_domain_bids(
...
) -> Result<crate::rest_api::codegen::models::DomainBids, Error<GetDomainBidsError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetDomainBidsError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
