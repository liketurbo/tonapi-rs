...
impl Message {
    pub fn new(msg_type: MsgType, created_lt: i64, ihr_disabled: bool, bounce: bool, bounced: bool, value: i64, fwd_fee: i64, ihr_fee: i64, import_fee: i64, created_at: i64) -> Message {
        Message {
            msg_type,
            created_lt,
            ihr_disabled,
