...
pub async fn account_dns_back_resolve(
...
) -> Result<crate::rest_api::codegen::models::DomainNames, Error<AccountDnsBackResolveError>> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<AccountDnsBackResolveError> =
...
pub async fn address_parse(
...
) -> Result<crate::rest_api::codegen::models::AddressParse200Response, Error<AddressParseError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<AddressParseError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
) -> Result<crate::rest_api::codegen::models::Account, Error<GetAccountError>> {
    let local_var_configuration = configuration;
...
) -> Result<crate::rest_api::codegen::models::GetAccountDiff200Response, Error<GetAccountDiffError>>
{
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetAccountDiffError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_account_dns_expiring(
...
) -> Result<crate::rest_api::codegen::models::DnsExpiring, Error<GetAccountDnsExpiringError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetAccountDnsExpiringError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_account_event(
...
) -> Result<crate::rest_api::codegen::models::AccountEvent, Error<GetAccountEventError>> {
    let local_var_configuration = configuration;
    ...
    if let Some(ref local_var_str) = subject_only {
        local_var_req_builder =
            local_var_req_builder.query(&[("subject_only", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_user_agent) = local_var_configuration.user_agent {
        local_var_req_builder =
            local_var_req_builder.header(reqwest::header::USER_AGENT, local_var_user_agent.clone());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetAccountEventError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_account_events(
...
) -> Result<crate::rest_api::codegen::models::AccountEvents, Error<GetAccountEventsError>> {
    let local_var_configuration = configuration;
    ...
    if let Some(ref local_var_str) = initiator {
        local_var_req_builder =
            local_var_req_builder.query(&[("initiator", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_str) = subject_only {
        local_var_req_builder =
            local_var_req_builder.query(&[("subject_only", &local_var_str.to_string())]);
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetAccountEventsError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
) -> Result<crate::rest_api::codegen::models::AccountEvents, Error<GetAccountJettonHistoryByIdError>>
{
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetAccountJettonHistoryByIdError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
) -> Result<crate::rest_api::codegen::models::JettonsBalances, Error<GetAccountJettonsBalancesError>>
{
    let local_var_configuration = configuration;
    ...
    if let Some(ref local_var_str) = currencies {
        local_var_req_builder =
            local_var_req_builder.query(&[("currencies", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_user_agent) = local_var_configuration.user_agent {
        local_var_req_builder =
            local_var_req_builder.header(reqwest::header::USER_AGENT, local_var_user_agent.clone());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetAccountJettonsBalancesError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_account_jettons_history(
...
) -> Result<crate::rest_api::codegen::models::AccountEvents, Error<GetAccountJettonsHistoryError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetAccountJettonsHistoryError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_account_nft_items(
...
) -> Result<crate::rest_api::codegen::models::NftItems, Error<GetAccountNftItemsError>> {
    let local_var_configuration = configuration;
    ...
    if let Some(ref local_var_str) = collection {
        local_var_req_builder =
            local_var_req_builder.query(&[("collection", &local_var_str.to_string())]);
    }
    ...
    if let Some(ref local_var_str) = indirect_ownership {
        local_var_req_builder =
            local_var_req_builder.query(&[("indirect_ownership", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_user_agent) = local_var_configuration.user_agent {
        local_var_req_builder =
            local_var_req_builder.header(reqwest::header::USER_AGENT, local_var_user_agent.clone());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetAccountNftItemsError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_account_public_key(
    ...
    crate::rest_api::codegen::models::GetAccountPublicKey200Response,
    Error<GetAccountPublicKeyError>,
> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetAccountPublicKeyError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_account_subscriptions(
...
) -> Result<crate::rest_api::codegen::models::Subscriptions, Error<GetAccountSubscriptionsError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetAccountSubscriptionsError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_account_traces(
...
) -> Result<crate::rest_api::codegen::models::TraceIds, Error<GetAccountTracesError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetAccountTracesError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
) -> Result<crate::rest_api::codegen::models::Accounts, Error<GetAccountsError>> {
    let local_var_configuration = configuration;
...
pub async fn reindex_account(
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ReindexAccountError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
) -> Result<crate::rest_api::codegen::models::FoundAccounts, Error<SearchAccountsError>> {
    let local_var_configuration = configuration;
