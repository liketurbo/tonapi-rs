...
*BlockchainApi* | [**get_raw_blockchain_config_from_block**](docs/BlockchainApi.md#get_raw_blockchain_config_from_block) | **GET** /v2/blockchain/blocks/{block_id}/config/raw | 
