...
pub struct EmulateMessageToWalletParams {
    ...
    pub emulate_message_to_wallet_request:
        crate::rest_api::codegen::models::EmulateMessageToWalletRequest,
    pub accept_language: Option<String>,
}
...
pub async fn decode_message(
...
) -> Result<crate::rest_api::codegen::models::DecodedMessage, Error<DecodeMessageError>> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<DecodeMessageError> =
...
) -> Result<crate::rest_api::codegen::models::AccountEvent, Error<EmulateMessageToAccountEventError>>
{
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<EmulateMessageToAccountEventError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn emulate_message_to_event(
...
) -> Result<crate::rest_api::codegen::models::Event, Error<EmulateMessageToEventError>> {
    let local_var_configuration = configuration;
    ...
    if let Some(ref local_var_str) = ignore_signature_check {
        local_var_req_builder =
            local_var_req_builder.query(&[("ignore_signature_check", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_user_agent) = local_var_configuration.user_agent {
        local_var_req_builder =
            local_var_req_builder.header(reqwest::header::USER_AGENT, local_var_user_agent.clone());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<EmulateMessageToEventError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn emulate_message_to_trace(
...
) -> Result<crate::rest_api::codegen::models::Trace, Error<EmulateMessageToTraceError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<EmulateMessageToTraceError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
) -> Result<crate::rest_api::codegen::models::MessageConsequences, Error<EmulateMessageToWalletError>>
{
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<EmulateMessageToWalletError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
