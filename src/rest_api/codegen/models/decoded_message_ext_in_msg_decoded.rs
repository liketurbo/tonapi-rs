...
pub struct DecodedMessageExtInMsgDecoded {
    ...
    pub wallet_v3:
        Option<Box<crate::rest_api::codegen::models::DecodedMessageExtInMsgDecodedWalletV3>>,
    #[serde(rename = "wallet_v4", skip_serializing_if = "Option::is_none")]
    pub wallet_v4:
        Option<Box<crate::rest_api::codegen::models::DecodedMessageExtInMsgDecodedWalletV4>>,
    #[serde(rename = "wallet_highload_v2", skip_serializing_if = "Option::is_none")]
    pub wallet_highload_v2: Option<
        Box<crate::rest_api::codegen::models::DecodedMessageExtInMsgDecodedWalletHighloadV2>,
    >,
}
