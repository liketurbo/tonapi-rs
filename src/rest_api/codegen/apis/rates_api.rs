...
pub async fn get_chart_rates(
...
) -> Result<crate::rest_api::codegen::models::GetChartRates200Response, Error<GetChartRatesError>> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetChartRatesError> =
...
) -> Result<crate::rest_api::codegen::models::GetRates200Response, Error<GetRatesError>> {
    let local_var_configuration = configuration;
