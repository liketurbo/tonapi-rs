...
pub struct Risk {
    ...
    pub jettons: Vec<crate::rest_api::codegen::models::JettonQuantity>,
    #[serde(rename = "nfts")]
    pub nfts: Vec<crate::rest_api::codegen::models::NftItem>,
}
...
impl Risk {
    ...
    pub fn new(
        ...
        ton: i64,
        jettons: Vec<crate::rest_api::codegen::models::JettonQuantity>,
        nfts: Vec<crate::rest_api::codegen::models::NftItem>,
    ) -> Risk {
        Risk {
