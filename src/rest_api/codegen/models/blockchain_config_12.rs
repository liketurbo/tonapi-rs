...
pub struct BlockchainConfig12 {
    ...
    pub workchains: Vec<crate::rest_api::codegen::models::WorkchainDescr>,
}

impl BlockchainConfig12 {
    /// Workchains in the TON Blockchain
    pub fn new(
        workchains: Vec<crate::rest_api::codegen::models::WorkchainDescr>,
    ) -> BlockchainConfig12 {
        BlockchainConfig12 { workchains }
    }
}
