...
pub async fn get_event(configuration: &configuration::Configuration, event_id: &str, accept_language: Option<&str>) -> Result<crate::models::Event, Error<GetEventError>> {
