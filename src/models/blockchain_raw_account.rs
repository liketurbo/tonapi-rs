...
pub struct BlockchainRawAccount {
    ...
    pub storage: Box<crate::models::AccountStorageInfo>,
}

impl BlockchainRawAccount {
    pub fn new(address: String, balance: i64, last_transaction_lt: i64, status: String, storage: crate::models::AccountStorageInfo) -> BlockchainRawAccount {
