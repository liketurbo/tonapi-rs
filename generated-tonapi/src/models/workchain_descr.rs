...
impl WorkchainDescr {
    pub fn new(workchain: i32, enabled_since: i64, actual_min_split: i32, min_split: i32, max_split: i32, basic: i32, active: bool, accept_msgs: bool, flags: i32, zerostate_root_hash: String, zerostate_file_hash: String, version: i64) -> WorkchainDescr {
        WorkchainDescr {
            workchain,
            enabled_since,
            actual_min_split,
