...
pub async fn get_blockchain_config_from_block(configuration: &configuration::Configuration, masterchain_seqno: i32) -> Result<crate::models::BlockchainConfig, Error<GetBlockchainConfigFromBlockError>> {
    let local_var_configuration = configuration;
...
pub async fn get_raw_blockchain_config_from_block(configuration: &configuration::Configuration, masterchain_seqno: i32) -> Result<crate::models::RawBlockchainConfig, Error<GetRawBlockchainConfigFromBlockError>> {
    let local_var_configuration = configuration;
