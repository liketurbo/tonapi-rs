...
pub struct SendBlockchainMessageParams {
    ...
    pub send_blockchain_message_request:
        crate::rest_api::codegen::models::SendBlockchainMessageRequest,
}
...
pub async fn blockchain_account_inspect(
    ...
    crate::rest_api::codegen::models::BlockchainAccountInspect,
    Error<BlockchainAccountInspectError>,
> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<BlockchainAccountInspectError> =
...
pub async fn exec_get_method_for_blockchain_account(
    ...
    crate::rest_api::codegen::models::MethodExecutionResult,
    Error<ExecGetMethodForBlockchainAccountError>,
> {
    let local_var_configuration = configuration;
    ...
    if let Some(ref local_var_str) = args {
        local_var_req_builder = match "multi" {
            "multi" => local_var_req_builder.query(
                &local_var_str
                    .into_iter()
                    .map(|p| ("args".to_owned(), p.to_string()))
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ExecGetMethodForBlockchainAccountError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_blockchain_account_transactions(
    ...
    crate::rest_api::codegen::models::Transactions,
    Error<GetBlockchainAccountTransactionsError>,
> {
    let local_var_configuration = configuration;
    ...
    if let Some(ref local_var_str) = after_lt {
        local_var_req_builder =
            local_var_req_builder.query(&[("after_lt", &local_var_str.to_string())]);
    }
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetBlockchainAccountTransactionsError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_blockchain_block(
...
) -> Result<crate::rest_api::codegen::models::BlockchainBlock, Error<GetBlockchainBlockError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetBlockchainBlockError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_blockchain_block_transactions(
    ...
    crate::rest_api::codegen::models::Transactions,
    Error<GetBlockchainBlockTransactionsError>,
> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetBlockchainBlockTransactionsError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_blockchain_config(
    configuration: &configuration::Configuration,
) -> Result<crate::rest_api::codegen::models::BlockchainConfig, Error<GetBlockchainConfigError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetBlockchainConfigError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_blockchain_config_from_block(
    ...
    crate::rest_api::codegen::models::BlockchainConfig,
    Error<GetBlockchainConfigFromBlockError>,
> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetBlockchainConfigFromBlockError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_blockchain_masterchain_blocks(
    ...
    crate::rest_api::codegen::models::BlockchainBlocks,
    Error<GetBlockchainMasterchainBlocksError>,
> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetBlockchainMasterchainBlocksError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_blockchain_masterchain_head(
    ...
    crate::rest_api::codegen::models::BlockchainBlock,
    Error<GetBlockchainMasterchainHeadError>,
> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetBlockchainMasterchainHeadError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_blockchain_masterchain_shards(
    ...
    crate::rest_api::codegen::models::BlockchainBlockShards,
    Error<GetBlockchainMasterchainShardsError>,
> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetBlockchainMasterchainShardsError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_blockchain_masterchain_transactions(
    ...
    crate::rest_api::codegen::models::Transactions,
    Error<GetBlockchainMasterchainTransactionsError>,
> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetBlockchainMasterchainTransactionsError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_blockchain_raw_account(
    ...
    crate::rest_api::codegen::models::BlockchainRawAccount,
    Error<GetBlockchainRawAccountError>,
> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetBlockchainRawAccountError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_blockchain_transaction(
...
) -> Result<crate::rest_api::codegen::models::Transaction, Error<GetBlockchainTransactionError>> {
    let local_var_configuration = configuration;
    ...
    let local_var_uri_str = format!(
        ...
        local_var_configuration.base_path,
        transaction_id = crate::rest_api::codegen::apis::urlencode(transaction_id)
    );
    let mut local_var_req_builder =
        local_var_client.request(reqwest::Method::GET, local_var_uri_str.as_str());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetBlockchainTransactionError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_blockchain_transaction_by_message_hash(
    ...
    crate::rest_api::codegen::models::Transaction,
    Error<GetBlockchainTransactionByMessageHashError>,
> {
    let local_var_configuration = configuration;
    ...
    let local_var_uri_str = format!(
        ...
        local_var_configuration.base_path,
        msg_id = crate::rest_api::codegen::apis::urlencode(msg_id)
    );
    let mut local_var_req_builder =
        local_var_client.request(reqwest::Method::GET, local_var_uri_str.as_str());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetBlockchainTransactionByMessageHashError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_blockchain_validators(
    configuration: &configuration::Configuration,
) -> Result<crate::rest_api::codegen::models::Validators, Error<GetBlockchainValidatorsError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetBlockchainValidatorsError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_raw_blockchain_config(
    configuration: &configuration::Configuration,
) -> Result<crate::rest_api::codegen::models::RawBlockchainConfig, Error<GetRawBlockchainConfigError>>
{
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetRawBlockchainConfigError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_raw_blockchain_config_from_block(
    ...
    crate::rest_api::codegen::models::RawBlockchainConfig,
    Error<GetRawBlockchainConfigFromBlockError>,
> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetRawBlockchainConfigFromBlockError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn send_blockchain_message(
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<SendBlockchainMessageError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
