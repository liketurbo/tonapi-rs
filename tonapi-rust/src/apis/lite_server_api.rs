...
pub struct SendRawMessageParams {
    ...
    pub send_raw_message_request: crate::models::SendRawMessageRequest
}
...
pub async fn get_all_raw_shards_info(configuration: &configuration::Configuration, params: GetAllRawShardsInfoParams) -> Result<crate::models::GetAllRawShardsInfo200Response, Error<GetAllRawShardsInfoError>> {
...
pub async fn get_raw_account_state(configuration: &configuration::Configuration, params: GetRawAccountStateParams) -> Result<crate::models::GetRawAccountState200Response, Error<GetRawAccountStateError>> {
    let local_var_configuration = configuration;
...
/// Get raw block proof
pub async fn get_raw_block_proof(configuration: &configuration::Configuration, params: GetRawBlockProofParams) -> Result<crate::models::GetRawBlockProof200Response, Error<GetRawBlockProofError>> {
    let local_var_configuration = configuration;
...
pub async fn get_raw_blockchain_block(configuration: &configuration::Configuration, params: GetRawBlockchainBlockParams) -> Result<crate::models::GetRawBlockchainBlock200Response, Error<GetRawBlockchainBlockError>> {
    let local_var_configuration = configuration;
...
pub async fn get_raw_blockchain_block_header(configuration: &configuration::Configuration, params: GetRawBlockchainBlockHeaderParams) -> Result<crate::models::GetRawBlockchainBlockHeader200Response, Error<GetRawBlockchainBlockHeaderError>> {
    let local_var_configuration = configuration;
...
pub async fn get_raw_blockchain_block_state(configuration: &configuration::Configuration, params: GetRawBlockchainBlockStateParams) -> Result<crate::models::GetRawBlockchainBlockState200Response, Error<GetRawBlockchainBlockStateError>> {
    let local_var_configuration = configuration;
...
/// Get raw config
pub async fn get_raw_config(configuration: &configuration::Configuration, params: GetRawConfigParams) -> Result<crate::models::GetRawConfig200Response, Error<GetRawConfigError>> {
    let local_var_configuration = configuration;
...
pub async fn get_raw_list_block_transactions(configuration: &configuration::Configuration, params: GetRawListBlockTransactionsParams) -> Result<crate::models::GetRawListBlockTransactions200Response, Error<GetRawListBlockTransactionsError>> {
    let local_var_configuration = configuration;
...
pub async fn get_raw_masterchain_info_ext(configuration: &configuration::Configuration, params: GetRawMasterchainInfoExtParams) -> Result<crate::models::GetRawMasterchainInfoExt200Response, Error<GetRawMasterchainInfoExtError>> {
    let local_var_configuration = configuration;
...
pub async fn get_raw_shard_block_proof(configuration: &configuration::Configuration, params: GetRawShardBlockProofParams) -> Result<crate::models::GetRawShardBlockProof200Response, Error<GetRawShardBlockProofError>> {
    let local_var_configuration = configuration;
...
/// Get raw shard info
pub async fn get_raw_shard_info(configuration: &configuration::Configuration, params: GetRawShardInfoParams) -> Result<crate::models::GetRawShardInfo200Response, Error<GetRawShardInfoError>> {
    let local_var_configuration = configuration;
...
pub async fn get_raw_transactions(configuration: &configuration::Configuration, params: GetRawTransactionsParams) -> Result<crate::models::GetRawTransactions200Response, Error<GetRawTransactionsError>> {
    let local_var_configuration = configuration;
...
pub async fn send_raw_message(configuration: &configuration::Configuration, params: SendRawMessageParams) -> Result<crate::models::SendRawMessage200Response, Error<SendRawMessageError>> {
    let local_var_configuration = configuration;
