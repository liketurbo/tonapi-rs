...
) -> Result<crate::rest_api::codegen::models::AccountStaking, Error<GetAccountNominatorsPoolsError>>
{
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetAccountNominatorsPoolsError> =
...
pub async fn get_staking_pool_history(
    ...
    crate::rest_api::codegen::models::GetStakingPoolHistory200Response,
    Error<GetStakingPoolHistoryError>,
> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetStakingPoolHistoryError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_staking_pool_info(
    ...
    crate::rest_api::codegen::models::GetStakingPoolInfo200Response,
    Error<GetStakingPoolInfoError>,
> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetStakingPoolInfoError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
) -> Result<crate::rest_api::codegen::models::GetStakingPools200Response, Error<GetStakingPoolsError>>
{
    let local_var_configuration = configuration;
    ...
    if let Some(ref local_var_str) = available_for {
        local_var_req_builder =
            local_var_req_builder.query(&[("available_for", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_str) = include_unverified {
        local_var_req_builder =
            local_var_req_builder.query(&[("include_unverified", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_user_agent) = local_var_configuration.user_agent {
        local_var_req_builder =
            local_var_req_builder.header(reqwest::header::USER_AGENT, local_var_user_agent.clone());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetStakingPoolsError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
