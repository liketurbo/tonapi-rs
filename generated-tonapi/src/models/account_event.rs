...
impl AccountEvent {
    ...
    pub fn new(event_id: String, account: crate::models::AccountAddress, timestamp: i64, actions: Vec<crate::models::Action>, is_scam: bool, lt: i64, in_progress: bool, extra: i64) -> AccountEvent {
        AccountEvent {
            event_id,
