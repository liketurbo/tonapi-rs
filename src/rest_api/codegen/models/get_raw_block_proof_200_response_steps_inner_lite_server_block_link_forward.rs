...
pub struct GetRawBlockProof200ResponseStepsInnerLiteServerBlockLinkForward {
    ...
    pub signatures: Box<
        crate::rest_api::codegen::models::GetRawBlockProof200ResponseStepsInnerLiteServerBlockLinkForwardSignatures,
    >,
}
...
impl GetRawBlockProof200ResponseStepsInnerLiteServerBlockLinkForward {
    pub fn new(
        ...
        dest_proof: String,
        config_proof: String,
        signatures: crate::rest_api::codegen::models::GetRawBlockProof200ResponseStepsInnerLiteServerBlockLinkForwardSignatures,
